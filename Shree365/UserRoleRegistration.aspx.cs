        ...
        protected void btnRoleSave_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtRoleName.Text != null)
                {
                    ...
                    string sqlUserExist = "SELECT Count(*) FROM UserRole_TB WHERE Status='1' AND RoleName = '" + txtRoleName.Text + "'";
                    ...
                    sqlComm.CommandText = "INSERT INTO UserRole_TB(RoleName, Status, ModifiedDate)" +
