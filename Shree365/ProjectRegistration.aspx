<%@ Page Title="Project Registration" Language="C#" MasterPageFile="/Shree.Master" AutoEventWireup="true" CodeBehind="/ProjectRegistration.aspx.cs" Inherits="Shree365.ProjectRegistration" %>
...
<asp:Panel runat="server" ID="pnlUsername" GroupingText="Project Registration">
    <table border="1" style="width:100%">	    
      ...
      <asp:SqlDataSource ConnectionString="Data Source=Shree365.db.12017601.hostedresource.com;Initial Catalog=Shree365;User ID=Shree365;Password=kHUSHI2002#;MultipleActiveResultSets=True;Application Name=EntityFramework"
          ...
          SelectCommand="SELECT [ProjectID],[ProjectName],[Domain], [Technology], [Details], [Project_Start_Dt], [Project_End_Dt] FROM [Projects_TB]" ProviderName="System.Data.SqlClient">
      </asp:SqlDataSource>
            </td>
        </tr>                                  
    </table>    
